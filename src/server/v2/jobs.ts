...
const allowedTransitions: Record<JobStatus, JobStatus[]> = {
  ...
  generating_content: ["searching_assets", "generating_voice", "failed"],
  searching_assets: ["generating_voice", "generating_captions", "rendering", "failed"],
  generating_voice: ["generating_captions", "searching_assets", "failed"],
  generating_captions: ["searching_assets", "rendering", "failed"],
